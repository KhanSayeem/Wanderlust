...
{
    /// <inheritdoc />
    public partial class FixedIdentityModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourPackages_AgencyProfiles_AgencyProfileId",
            ...
            migrationBuilder.CreateTable(
                name: "AmenityTourPackage",
                columns: table => new
                {
                    AmenitiesId = table.Column<int>(type: "int", nullable: false),
                    TourPackagesId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmenityTourPackage", x => new { x.AmenitiesId, x.TourPackagesId });
                    table.ForeignKey(
                        name: "FK_AmenityTourPackage_Amenities_AmenitiesId",
                        column: x => x.AmenitiesId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmenityTourPackage_TourPackages_TourPackagesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TourDates_TourPackages_TourPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TourPackageAmenities", x => new { x.TourPackageId, x.AmenityId });
                    table.ForeignKey(
                        name: "FK_TourPackageAmenities_Amenities_AmenityId",
                        column: x => x.AmenityId,
                        principalTable: "Amenities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TourPackageAmenities_TourPackages_TourPackageId",
                        column: x => x.TourPackageId,
                        principalTable: "TourPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityTourPackage_TourPackagesId",
                table: "AmenityTourPackage",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourDates_TourPackageId",
                table: "TourDates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TourPackageAmenities_AmenityId",
                table: "TourPackageAmenities",
                column: "AmenityId");

            migrationBuilder.CreateIndex(
                name: "IX_TourPackages_AgencyProfileId",
                table: "TourPackages",
